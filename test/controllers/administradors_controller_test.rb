...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference("Administrador.count") do
      post administradors_url, params: { administrador: { usuario_id: @administrador.usuario_id } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { usuario_id: @administrador.usuario_id } }

...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, marca: @producto.marca, nombre: @producto.nombre, presentacion: @producto.presentacion } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, marca: @producto.marca, nombre: @producto.nombre, presentacion: @producto.presentacion } }

class NotificacionsController < ApplicationController
  ...
  private
    ...
    def set_notificacion
      @notificacion = Notificacion.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def notificacion_params
      params.expect(notificacion: [ :tipo_notificacion_id, :mensaje, :fecha_envio, :estado_leido, :medio, :usuario_id, :producto_id ])
    end
end
